...
<?php 
$categoryfield = get_page_by_path('page-categoryfield');
$id = $categoryfield->ID;
?>
<?php
        ...
        <h2 class="c-archive--titlle">
          ...
          <?php 
            if (is_plugin_active('custom-field-suite/cfs.php')) {
              $category_title = CFS()->get('category_title',$id); 
              ...
              echo 'プラグインCFSを有効にし、カテゴリー一覧ページの見出しを入力します';
            }
          ?>
        </h2>
        <p>
          <?php 
            if (is_plugin_active('custom-field-suite/cfs.php')) {
              $category_text = CFS()->get('category_text',$id);
              ...
              echo 'プラグインCFSを有効にし、カテゴリー一覧ページの説明文を入力します。プラグインCFSを有効にし、お知らせ一覧ページの説明文を入力します。';
            }
          ?>
        </p>
