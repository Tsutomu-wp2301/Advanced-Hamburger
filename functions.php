...
function add_files(){
    ...
    wp_enqueue_script('link_TakeOut_script', get_template_directory_uri().'/JS/js-takeOut.js', array(),'1.0.0',true);
    wp_enqueue_script('link_EatIn_script', get_template_directory_uri().'/JS/js-eatIn.js', array(),'1.0.0',true);
