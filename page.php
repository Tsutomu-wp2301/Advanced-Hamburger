<?php get_header(); ?><!-- ヘッダーの呼び出し -->
      <section>
        ...
        <article class="p-single--layout">
          <h2>見出しh2</h2>
          <p>Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。Pタグテキスト。</p>
          <h3>見出しh3</h3>
          <h4>見出しh4</h4>
          <h5>見出しh5</h5>
          <h6>見出しh6</h6>
          ...
          <article class="p-flex--single">
            ...
            <div class="p-flex--single-content"><!-- 写真とテキストを横並び -->
              ...
              <P>テキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　</P>
            </div>
            <div class="p-flex--single-content"><!-- 写真とテキストを横並び -->
              <div class="p-product--image"></div>
              <P class="left">テキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入ります入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入ります入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入りますテキストが入ります　テキストが入ります</P>
            </div>
